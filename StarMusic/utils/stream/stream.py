...
import config
from StarMusic import Carbon, YouTube, app
from StarMusic.core.call import Star
from StarMusic.misc import db
from StarMusic.utils.database import (add_active_chat,
                                       add_active_video_chat,
                                       is_active_chat,
                                       is_video_allowed, music_on)
from StarMusic.utils.exceptions import AssistantErr
from StarMusic.utils.inline.play import (stream_markup,
                                          telegram_markup)
from StarMusic.utils.inline.playlist import close_markup
from StarMusic.utils.pastebin import Starbin
from StarMusic.utils.stream.queue import put_queue, put_queue_index
...
async def stream(
    ...
    if forceplay:
        await Star.force_stop_stream(chat_id)
