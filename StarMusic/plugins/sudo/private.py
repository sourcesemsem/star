...
from StarMusic.utils.database import (add_private_chat,
...
@app.on_message(filters.command(["رفع مسؤول"],"") & SUDOERS)
@language
...
@app.on_message(filters.command(["تنزيل مسؤول"],"") & SUDOERS)
@language
...
@app.on_message(filters.command(["المسؤوليين"],"") & SUDOERS)
@language
