...
from StarMusic.utils.database import add_gban_user, remove_gban_user
...
@app.on_message(filters.command(["منع"],"") & SUDOERS)
@language
...
@app.on_message(filters.command(["سماح"],"") & SUDOERS)
@language
...
@app.on_message(filters.command(["الممنوعين"],"") & SUDOERS)
@language
