...
from StarMusic.utils.database import add_sudo, remove_sudo
...
@app.on_message(
    filters.command(["رفع مطور"],"") & filters.user(OWNER_ID)
)
@language
async def useradd(client, message: Message, _):
    if MONGO_DB_URI is None:
        return await message.reply_text(
            "**Due to bot's privacy issues, You can't manage sudo users when you're using star's Database.\n\n Please fill your MONGO_DB_URI in your vars to use this feature**"
        )
...
@app.on_message(
    filters.command(["تنزيل مطور"],"") & filters.user(OWNER_ID)
)
@language
...
@app.on_message(filters.command(["المطورين"],"") & ~BANNED_USERS)
@language
