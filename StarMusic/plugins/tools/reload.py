...
from StarMusic.utils.database import get_authuser_names, get_cmode
from StarMusic.utils.decorators import (ActualAdminCB, AdminActual,
                                         language)
from StarMusic.utils.formatters import alpha_to_int
...
async def restartbot(client, message: Message, _):
    ...
    try:
        db[message.chat.id] = []
        await Star.stop_stream(message.chat.id)
    except:
        pass
