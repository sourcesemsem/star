...
async def init():
    ...
    for all_module in ALL_MODULES:
        importlib.import_module("StarMusic.plugins" + all_module)
    LOGGER("StarMusic.plugins").info(
...
if __name__ == "__main__":
    ...
    LOGGER("StarMusic").info("Stopping StarMusic Bot! GoodBye")
